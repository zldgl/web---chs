...
;=========================================
	...
	tf.img_path = '../others/plugin/theme_kopanda_09/image/config/';
...
*ch_speed_change
	...
	[position layer="message1" left="90" top="560" width="1100" height="100" margint="2" marginl="30" page="fore" visible="true" opacity="0"]
