...
;タイトルロゴepi1
[chara_new name="title_logo2" storage="title_logo_epi2.png"]
...
[chara_show name="title_logo2" time=300 layer=2 wait=true left=0 top=50]
...
[button name="title_button" x=550 y=470 enterimg="Title_StartB.png" graphic="Title_Start.png" storage="scene13a.ks"]
